...
<?php  
	//message de d�connexion r�ussie
	    if ($_GET['disconnect']=="true" )
{
		echo '<div style="background-color:#006600;color:white;width:100%;height:30px;padding-top:13px;">Deconnexion r�ussie</div><br>';
}
...
Rester connect� : <input type="checkbox" name="cookieetudiant" value="1"  ><br><br>
...
Rester connect� : <input type="checkbox" name="cookieprof" value="1"  ><br>
...
?>
    D&eacute;velopp&eacute; par <span style="font-weight:bold;">Bruno MILLION</span> (IUT GMP) et par <span style="font-weight:bold;">Ga&euml;tan COLOMBIER</span> (IUT GMP) pour le PST de Ville d'Avray (Universit� Paris Ouest) - <?php echo $compteur;?> pages vues.<br>
	...
	<br>
	    ...
	    <a href="http://www.mozilla-europe.org">Affichage optimis� pour Firefox<img style="border:0;width:67px;height:25px" src="firefox.png" alt="optimis� pour Firefox" ></a>
	...
	<a style="color:#0000EE" href="index.php?smartphone=oui">Utiliser l'interface web optimis�e pour les t�l�phones portables</a>
