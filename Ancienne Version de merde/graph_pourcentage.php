...
$sql="SELECT *  FROM seances_profs left join seances on seances.codeSeance=seances_profs.codeSeance WHERE seances_profs.codeRessource=".$selec_prof." and seances_profs.deleted='0' and seances.deleted='0' ";
...
// on commence en septembre donc septembre=$i+8
 ...
 unset ($req_seance);
$sql="SELECT *  FROM seances_profs left join seances on seances.codeSeance=seances_profs.codeSeance WHERE seances_profs.codeRessource=".$selec_prof." and seances_profs.deleted='0' and seances.deleted='0' and month(dateSeance)=".$j;
...
$duree_en_min+=$heureduree*60+	$minduree;
...
$datay[] = $duree_en_min/$duree_en_min_annee*100;
$dataycumul[] = $duree_en_min_cumul/$duree_en_min_annee*100;
$datax[] = $nom_mois;
...
// Setup title
$graph->title->Set("Répartition des heures sur l'année (en %)");
