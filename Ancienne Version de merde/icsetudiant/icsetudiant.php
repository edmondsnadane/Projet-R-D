...
$ressources_etudiants = mysql_query("SELECT * FROM ressources_etudiants WHERE deleted='0'");
while ($ressource_etudiant = mysql_fetch_array($ressources_etudiants) )
{
	...
	$fichier.="X-WR-CALNAME:".$ressource_etudiant['nom']. "\n";
	$fichier.="X-WR-TIMEZONE:Europe/paris". "\n";
	$code_etudiant=$ressource_etudiant['codeEtudiant'];
$groupes = mysql_query("SELECT * FROM ressources_groupes_etudiants RIGHT JOIN ressources_groupes ON ressources_groupes_etudiants.codeGroupe=ressources_groupes.codeGroupe WHERE ressources_groupes_etudiants.codeEtudiant='$code_etudiant' and ressources_groupes_etudiants.deleted='0' and ressources_groupes.deleted='0'");
...
while ($reservation_groupe = mysql_fetch_array($reservations_groupes) )
	...
	if ($ressource_etudiant['nom']!=$ressource_etudiant['prenom'])
	{
	$nomfichier=$ressource_etudiant['nom']."_".$ressource_etudiant['prenom'].".ics";
	...
	{
	$nomfichier=$ressource_etudiant['identifiant'].".ics";
//	$nomfichier=ereg_replace("[ ]","_",$nomfichier);
$nomfichier=preg_replace('/\s/',"_",$nomfichier);
